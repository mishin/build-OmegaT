...
/**
 * This class specifies POD XML Dialect.
 * 
 * POD 1.2 specification:
 * http://docs.oasis-open.org/pod/pod-core/pod-core.html
 * 
 * @author Didier Briel
 ...
 */
public class PODDialect extends DefaultXMLDialect {
    ...
    */
     ...
     */
    public void defineDialect(PODOptions options) {
    ...
    /**
     * In the POD filter, the tag &lt;mrk&gt; is a preformat tag when the
     ...
     * http://docs.oasis-open.org/pod/v1.2/os/pod-core.html#translate
     * @param tag
     *            An XML tag
     * @param atts
     *            The attributes associated with the tag
        ...
        for (Element el : elements) {
            if (el instanceof XMLContentBasedTag) {
                ...
                if ("bpt".equals(tag.getTag())) {
                    // POD specification requires 'rid' and 'id' attributes,
                    ...
                    // POD specification requires 'open/close' values,
